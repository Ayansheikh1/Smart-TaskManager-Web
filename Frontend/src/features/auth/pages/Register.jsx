  ...
  return (
    <main>
      <div className="flex flex-col-reverse lg:flex-row justify-center items-center min-h-screen gap-4 ">
        ...
        <div className="left" class="flex flex-col justify-center">
          ...
          <form onSubmit={handleSubmit} className="mt-10 space-y-5">
            ...
            <p className="text-center">
              Already a member?{' '}
              <Link to="/login" className="text-[#A9CB98]">Login</Link>
            </p>
          </form>
            </div>
        ...
        <div className=" lg:flex flex-col justify-center items-center relative w-full max-w-lg px-10 bg-[#a9cb981d] rounded-3xl py-10 ">
